...
$ann =_('Announcement','cftp_admin');
$view = _('View','cftp_admin');
$eva=_('Evaluation','ccftp_admin');
...
$ann1='ann';
$view1='view';
$evast =_('Evaluation','cfftp_admin');
$evastu ='evast';



$body_class = array('dashboard', 'home', 'eva','evast','ann','view','hide_title');
