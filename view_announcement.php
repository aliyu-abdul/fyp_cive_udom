...
$page_title = __('View Announcements', 'cftp_admin');
include('header.php');
...
yearRange: "1970:<?php echo date('Y');?>"
		...
		?>
		 ...
		 <?php
		   $sql = "SELECT title,body,postedby,time FROM tbl_posts";
		...
		?>
               <div class="panel panel-default">
			       <div class="panel-heading">
                      <p class="text-center" h6><?=$rows['title'];?></p>
				   </div>
				   <div class="panel-body h5" style="border-left: 5px solid blue;">
                     <p>
					 <?=$rows['body'];?>
                     </p>
					 <span class="pull-right h5" style="margin-right:100px;">
					 Posted By : <?=$rows['postedby'];?> , Posted on : <?=$rows['time'];?>
					 </span>
				   </div>
               </div>
			   <?php
