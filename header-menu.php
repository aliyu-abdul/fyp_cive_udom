	...
	*/
	...
	$items['clients']	= array(
								...
								'sub'	=> array(
												...
												array(
													'label'	=> __('Manage Students', 'cftp_admin'),
													'link'	=> 'clients.php',
	...
	$items['groups']	= array(
								...
								'level'	=> array( 8,7,9 ),
								'main'	=> array(
												'label'	=> __('Students groups', 'cftp_admin'),
												'icon'	=> 'th-large',
	...
	$items['ann'] = array(
		...
		'level'	=> array( 8,7 ),
		'main'	=> array(
						'label'	=> __('Post announcement', 'ccftp_admin'),
						'icon'	=> 'tachometer',
	...
	$items['view'] = array(
		...
		'level'	=> array( 8,7 ),
		'main'	=> array(
						'label'	=> __('View Annoucement', 'cftp_admin'),
						'icon'	=> 'tachometer',
						'link'	=> 'view_announcement.php',
					),
	);
...
$items[]			= 'separator';
	...
	$items['eva'] = array(
		...
		'level'	=> array( 8 ),
		'main'	=> array(
						'label'	=> __('Evaluation', 'ccftp_admin'),
						'icon'	=> 'tachometer',
						'link'	=> 'informationsystem.php',
					),
	);
	...
	$items['view_files'] = array(
						...
						$items[]			= 'separator';
							...
							$items['evast'] = array(
								...
								'level'	=> array(0),
								'main'	=> array(
												'label'	=> __('Evaluation', 'cfftp_admin'),
												'icon'	=> 'tachometer',
												'link'	=> 'college.php',
											),
							);
