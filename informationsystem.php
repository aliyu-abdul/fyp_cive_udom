...
$allowed_levels = array(8);
require_once('sys.includes.php');


$page_title = __('Evaluation Conducted', 'cftp_admin');
include('header.php');
...
?>
        <!-- <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Students evaluations views <h1 style="color:aqua;">(Department of information system)</h1>  
						<?php
		...
		<div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-sorting table-responsive">
                              ...
                              <tbody>
                              <?php $ret=mysqli_query($con,"SELECT * FROM evaluation1 where `department` = 'DOIS'");
							  $cnt=1;
		        ...
		        <a href="informationsystem.php?id=<?=$row['id'];?>" onclick ="return confirm('Are you sure you want to delete?');">DELETE</a>
                                  </td>
                              </tr>
                              <?php $cnt=$cnt+1; }?>
